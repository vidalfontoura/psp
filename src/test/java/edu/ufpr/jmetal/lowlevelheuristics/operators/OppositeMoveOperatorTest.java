 ...
 * @author Vidal
 */
public class OppositeMoveOperatorTest {
    ...
    public void setup() {
        ...
        random.setSeed(100);
        operator = new OppositeMoveOperator(1.0, random);
    }

    /**
     * <pre>
     *   F,F,L,L,U,U,U,L,L,L,D,D,U,D,D,L,F,L,L,
     *   F,F,L,L,U,U,D,L,L,L,D,D,U,D,D,L,F,L,L,
     *          
     *             opposite
     * </pre>
     */
    ...
    public void testOperator19Genes() {
        ...
        Assert.assertEquals("[F,F,R,L,U,U,D,L,L,L,D,D,U,D,D,R,F,L,L]", offspringStr);
    ...
    public void testOperator19GenesSeed1() {
        ...
        Assert.assertEquals("[F,L,U,R,L,L,L,D,R,R,L,R,U,R,D,R,D,D,U]", offspringStr);
