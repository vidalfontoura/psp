 ...
 * @author Vidal
 */
public class MultiPointsCrossover implements CrossoverOperator<IntegerSolution> {

    private double crossoverProbability;
    private JMetalRandom randomGenerator;

    public MultiPointsCrossover(double crossoverProbability, JMetalRandom randomGenerator) {
